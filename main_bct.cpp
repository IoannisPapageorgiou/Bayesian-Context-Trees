...
//2.The ONLY remaining thing is to load the data file in the first line of the main function, and then run the code.
...
int main() {
	...
	//1. Read data xn
	string s = "example_file.txt";              // After setting the initial inputs at the top of the file,
